...
class FredericiaKommuneJob extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'cronjob:FredericiaKommuneJob';
    ...
    public function handle()
    {
        $src = ['oe', 'aa', 'ae'];
        $dst = ['ø', 'å', 'æ'];
        $company_name = 'Fredericia Kommune';
        $base_url = 'https://www.fredericia.dk/';
        ...
        $crawler = $goutte->request('GET', 'https://fredericia.emply.net/overview/fredericia.aspx?mediaId=826948ae-001b-4bfe-b20f-285320767149');
            ...
            if (isset($value['Job Title']) && $value['Job Title'] != '') {
                ...
                if ($work_city != '') {
                    ...
                    if ($city) {
                        ...
                        $place_model->company = 'Fredericia Kommune';
                        if ($place_model->save()) {
                ...
                $job_logo = 'fredericia_kommune.png';
                ...
                $new_job->company = 'Fredericia Kommune';
