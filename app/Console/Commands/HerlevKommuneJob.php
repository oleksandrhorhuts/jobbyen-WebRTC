...
class HerlevKommuneJob extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'cronjob:HerlevKommuneJob';
    ...
    public function handle()
    {
        $src = ['oe', 'aa', 'ae'];
        $dst = ['ø', 'å', 'æ'];
        $company_name = 'Herlev Kommune';
        $base_url = 'https://herlev.dk/';
        ...
        $crawler = $goutte->request('GET', 'https://herlev.emply.net/overview/herlev.aspx?mediaId=f1fb8e12-1928-4328-88fd-9918a34a2bf2');
            ...
            if (isset($value['Job Title']) && $value['Job Title'] != '') {
                ...
                if ($work_city != '') {
                    ...
                    if ($city) {
                        ...
                        $place_model->company = 'Herlev Kommune';
                        if ($place_model->save()) {
                ...
                $new_job->company = 'Herlev Kommune';
