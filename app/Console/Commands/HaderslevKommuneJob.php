...
class HaderslevKommuneJob extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'cronjob:HaderslevKommuneJob';
    ...
    public function handle()
    {
        $src = ['oe', 'aa', 'ae'];
        $dst = ['ø', 'å', 'æ'];
        $company_name = 'Haderslev Kommune';
        $base_url = 'https://www.haderslev.dk/';
        ...
        $crawler = $client->request('GET', 'https://www.haderslev.dk/umbraco/api/job/search/?contextId=2931&jobCategory=&limit=4&offset=0');
        ...
        $crawler = $client->request('GET', 'https://www.haderslev.dk/umbraco/api/job/search/?contextId=2931&jobCategory=&limit=4&offset='.$current_pagination);
        $jobs_data = json_decode($client->getResponse()->getContent());
        ...
        foreach ($jobs_data->data as $index => $job) {
            $job_title = $job->name;
            $job_url = 'https://www.haderslev.dk'.$job->url;
            ...
            $job_description_html = $crawler->filter('.grid__control')->html();
            ...
            if (isset($value['Job Title']) && $value['Job Title'] != '') {
                ...
                if ($work_city != '') {
                    ...
                    if ($city) {
                        ...
                        $place_model->company = 'Haderslev Kommune';
                        if ($place_model->save()) {
                ...
                $job_logo = 'haderslev_kommune.png';
                ...
                $new_job->company = 'Haderslev Kommune';
