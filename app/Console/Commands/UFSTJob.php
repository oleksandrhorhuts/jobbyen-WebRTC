...
class UFSTJob extends Command
{
     ...
     * @var string
     */
    protected $signature = 'cronjob:UFSTJob';
    ...
    public function handle()
    {
        ...
        $company_name = 'Udviklings- og Forenklingsstyrelsen';
        $base_url = 'https://www.ufst.dk';
        $data = [];
        $client = new Client();
        // $client->setClient(new GuzzleClient(array('verify' => false)));
        $crawler = $client->request('GET', 'https://www.ufst.dk/api/jobs/get?take=100&depIds=9414,9690&sortBy=ApplicationDue');
    	    ...
    	    if(isset($value['Job Title']) && $value['Job Title'] !='')
    	    {
                ...
                if ($work_city != '') {
                    ...
                    if ($city) {
                        ...
                        $place_model->company = 'Udviklings- og Forenklingsstyrelsen';
                        if ($place_model->save()) {
                ...
                $job_logo = 'udviklings_forenklingsstyrelse.png';
                ...
                $new_job->company = 'Udviklings- og Forenklingsstyrelsen';
