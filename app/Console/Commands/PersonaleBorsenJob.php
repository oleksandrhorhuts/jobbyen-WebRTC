...
class PersonaleBorsenJob extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'cronjob:PersonaleBorsenJob';
    ...
    public function handle()
    {
        ...
        $src = ['oe', 'aa', 'ae'];
        $dst = ['ø', 'å', 'æ'];
        $company_name = 'PersonaleBørsen';
        $base_url = 'https://personaleborsen.dk/';
			...
			if (isset($value['Job Title']) && $value['Job Title'] != '') {
				...
				if ($work_city != '') {
					...
					if ($city) {
						...
						$place_model->company = 'PersonaleBørsen';
						if ($place_model->save()) {
				...
				$new_job->company = 'PersonaleBørsen';
