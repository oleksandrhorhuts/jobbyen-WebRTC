...
class StruerKommuneJob extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'cronjob:StruerKommuneJob';
    ...
    public function handle()
    {
        $src = ['oe', 'aa', 'ae'];
        $dst = ['ø', 'å', 'æ'];
        $company_name = 'STRUER KOMMUNE';
        $base_url = 'https://www.struer.dk/';
        ...
        $crawler = $goutte->request('GET', 'https://signatur.frontlab.com/ExtJobs/DefaultHosting/JobList.aspx?ClientId=1529');
            ...
            if (isset($value['Job Title']) && $value['Job Title'] != '') {
                ...
                if ($work_city != '') {
                    ...
                    if ($city) {
                        ...
                        $place_model->company = 'STRUER KOMMUNE';
                        if ($place_model->save()) {
                ...
                $new_job->company = 'STRUER KOMMUNE';
