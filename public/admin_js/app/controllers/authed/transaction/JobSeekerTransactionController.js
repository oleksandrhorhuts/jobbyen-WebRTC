...
angular.module('AdminApp').controller('JobSeekerTransactionController', function ($rootScope, $scope, $state, $http, bsLoadingOverlayService) {
    ...
    $scope.view_pdf = function (invoice_id) {
        ...
        $http.post("/admin-api/make_invoice_pdf", { invoice_id: invoice_id, type: 1 }).success(function (data) {
    ...
    $http.get("/admin-api/get_jobseeker_transactions").success(function (data) {
