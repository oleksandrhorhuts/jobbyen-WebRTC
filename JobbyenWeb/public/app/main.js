...
BotApp.directive('partCamItem', function (API_URL, $state, $rootScope) {
    return {
        ...
        link: function ($scope, element) {
            ...
            if ($scope.track.track.name == $scope.localAudioTrackName) {
...
BotApp.directive('camItem', function (API_URL, $state, $rootScope) {
    return {
        ...
        link: function ($scope, element) {
            ...
            // $scope.$watch('itemStyle', (newValue, oldValue) => {
            ...
            //             console.log(parseInt(newValue.left));
            //             var _x = parseInt(parseInt(newValue.left) / 100 * 1920);
            //             var _y = parseInt(parseInt(newValue.top) / 100 * 1080);
            //             var _width = parseInt(parseInt(newValue.width) / 100 * 1920);
            //             var _height = parseInt(parseInt(newValue.height) / 100 * 1080);

            //             console.log('_x = ' + _x);
            //             console.log('_y = ' + _y);
            //             console.log('_width = ' + _width);
            //             console.log('_height = ' + _height);
            //             draw_video($scope.track.track.name, mediaElement, context, _x, _y, _width, _height);
            ...
            //             console.log('_width = ' + _width);
            //             console.log('_height = ' + _height);
            //             draw_screen($scope.track.track.name, mediaElement, context, _x, _y, _width, _height);
            //         } else {
            ...
            // function draw_video(track_name, video, context, x, y, width, height) {
            //     context.drawImage(video, x, y, width, height);
            //     const h = setTimeout(draw_video, 10, track_name, video, context, x, y, width, height);
            //     handles.push(h);
            //     $rootScope.handles.push(h);
            // }
            // function draw_screen(track_name, video, context, x, y, width, height) {

            //     context.drawImage(video, x, y, width, height);
            //     const h = setTimeout(draw_screen, 10, track_name, video, context, x, y, width, height);
            //     handles.push(h);
            //     $rootScope.handles.push(h);
...
BotApp.directive('broadcastScreen', function (API_URL, $state, $rootScope) {
    return {
        ...
        link: function ($scope, element) {
            ...
            $scope.$watch('infos', (newValue, oldValue) => {
                $scope.$evalAsync(($scope) => {
                    for (var idx = 0; idx < $scope.infos.length; idx++) {
                        for (var _idx = 0; _idx < $scope.broadcast_tracks.length; _idx++) {
                            if ($scope.infos[idx].track_name == $scope.broadcast_tracks[_idx].track_name) {
                                $scope.broadcast_tracks[_idx].label = $scope.infos[idx].label;
                                break;
                            }
                        }
                    }
            ...
            $scope.$watch('trackId', (newValue, oldValue) => {
                ...
                $scope.$evalAsync(($scope) => {
                    ...
                    for (var key in $scope.trackId) {

                        console.log($scope.trackId[key]);
                        let track = $scope.tracks.find(x => x.track.name == $scope.trackId[key].track_name);
                        let _info = $scope.infos.find(x => x.track_name == $scope.trackId[key].track_name);
                        if (track) {
                            var _obj = {
                                track: track,
                                style: {
...
BotApp.directive('recordBroadcastScreen', function (API_URL, $state, $rootScope) {
    return {
        restrict: 'E',
        replace: true,
        templateUrl: 'js/app/directives/record-broadcast-screen.html',
        scope: {
            layout: '=layout',
            trackId: '=trackId',
            session: '=session'
            ...
            $scope.$watch('trackId', (newValue, oldValue) => {
                ...
                $scope.$evalAsync(($scope) => {
                    ...
                    for (var key in $scope.trackId) {
                        ...
                        var _exist_btrack = $scope.broadcast_tracks.find(x => x.track_name == $scope.trackId[key].track_name);
                        if (!_exist_btrack) {
                            var _obj = {
                                style: {
                                    top: '0%',
                                ...
                                type: $scope.trackId[key].track_type,
                                track_name: $scope.trackId[key].track_name,
